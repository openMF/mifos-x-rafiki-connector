# Contributing to mifos-x-rafiki-connector

Thank you for your interest in contributing to the mifos-x-rafiki-connector! We welcome contributions from the community to help improve financial inclusion solutions globally.
...
- Have a look at our [Wiki](https://github.com/openMF/mifos-x-rafiki-connector/wiki).
...
- Fork the [project](https://github.com/openMF/mifos-x-rafiki-connector) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/mifos-x-rafiki-connector.git
```
...
```bash
git remote add upstream https://github.com/openMF/mifos-x-rafiki-connector.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/mifos-x-rafiki-connector.git (fetch)
  > origin    https://github.com/your-username/mifos-x-rafiki-connector.git (push)
  > upstream  https://github.com/openMF/mifos-x-rafiki-connector.git (fetch)
  > upstream  https://github.com/openMF/mifos-x-rafiki-connector.git (push)
```
